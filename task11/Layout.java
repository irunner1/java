	...
	public Layout() {
        ...
        btn1.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent event) {
                JOptionPane.showMessageDialog(null, "Добро пожаловать в Сакака", "alert", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        btn2.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent event) {
                JOptionPane.showMessageDialog(null, "Добро пожаловать в Абха", "alert", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        btn5.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent event) {
                JOptionPane.showMessageDialog(null, "Добро пожаловать в Дахран", "alert", JOptionPane.INFORMATION_MESSAGE);
            }
        });
	}
